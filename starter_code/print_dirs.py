...
HAPPY CASES LEFT FOR THIS AND ABOVE
this is the code for the file
    import os

    folder_name = 'your_folder'  # Replace 'your_folder' with your desired folder name
    file_name = 'your_file.txt'  # Replace 'your_file.txt' with your desired file name
    ...
    with open(file_path, 'w') as file:
        pass  # This will create a file with 0 bytes size
...
def test_get_tree_at_position_multiple_leaves() -> None:
    #  This test case should fail on my mac
    """
...
# def test_get_tree_at_position_no_leaves() -> None:
#     """
#     Test that the method returns None when there are no leaves in the
#     displayed tree rooted at this tree.
#     """
#     tree = FileSystemTree(path3)
#     tree.update_rectangles((0, 0, 100, 100))
#     #  remove all the subtrees so that we get a blank screen
#     tree.expand()
#     for subtree in tree._subtrees:
#         subtree.delete_self()
#     result = tree.get_tree_at_position((20, 20))
...
"""testing for task 6
its commented out due to codetierlist"""
